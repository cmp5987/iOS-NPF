...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let parkNav = tabBarController?.viewControllers![1] as! UINavigationController
        let favoritesNav = tabBarController?.viewControllers![2] as! UINavigationController
        let aboutVC = tabBarController?.viewControllers![3] as! AboutViewController
        
        let parksVC = parkNav.viewControllers[0] as! ParksTableViewController
        let favoritesVC = favoritesNav.viewControllers[0] as! FavoritesTableViewController
